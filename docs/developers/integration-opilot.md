...
This guide describes how `llm-stream-parser` can be integrated with GitHub Copilot Chat extensions and chat hosts.
...
```typescript
import { ThinkingParser, createXmlStreamFilter } from 'llm-stream-parser';
...
```typescript
import { parseJson, validateJsonSchema, buildRepairPrompt } from 'llm-stream-parser';
...
- **Subpath imports** - Only import what you need: `import { ThinkingParser } from 'llm-stream-parser/thinking'`
