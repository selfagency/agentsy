...
Use `@agentsy/context` when you need lightweight budget enforcement around model usage, conversation trimming before context overflow, or rate-aware pacing across providers.
