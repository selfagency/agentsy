...
test.describe('compress-memory command', function() {
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    ...
                    case 2:
                        ...
                        return [
                            4,
                            terminal.submit("node dist/cli.js compress-memory --file ".concat(file))
                        ];
                    case 3:
                        _state.sent();
                        return [
    ...
    test('creates a .original.md backup file', function(param) {
        var terminal = param.terminal;
        return _async_to_generator(function() {
            var dir, file;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    ...
                    case 3:
                        ...
                        return [
                            4,
                            terminal.submit("test -f ".concat(file, ".original.md && echo 'BACKUP_EXISTS'"))
                        ];
                    case 4:
                        _state.sent();
                        return [
                            4,
                            expect(terminal.getByText('BACKUP_EXISTS')).toBeVisible()
                        ];
                    case 5:
                        _state.sent();
                        return [
    ...
    test('shows error when --file is missing', function(param) {
        var terminal = param.terminal;
        return _async_to_generator(function() {
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        return [
                            4,
                            terminal.submit('node dist/cli.js compress-memory')
                        ];
                    case 1:
                        _state.sent();
                        return [
                            4,
                            expect(terminal.getByText('Missing --file for compress-memory command.')).toBeVisible()
                        ];
                    case 2:
                        _state.sent();
                        return [
