...
describe("ThinkingBlock Component", () => {
  ...
  describe("theme handling", () => {
    it("respects theme colors for blockquote", () => {
      ...
      expect(element.props.theme.thinking.borderColor).toBe(
        darkTheme.thinking.borderColor
      );
      expect(element.props.theme.thinking.spinnerColor).toBe(
        darkTheme.thinking.spinnerColor
      );
    });
