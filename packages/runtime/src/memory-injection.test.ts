...
import { buildRuntimeMemoryContextXml, injectRuntimeMemoryContext } from './memory-injection.js';
...
describe('runtime memory injection', () => {
  ...
  it('injects context ahead of prompt and replaces existing memory_context block', () => {
    const existing = '<memory_context><memory_item id="old" /></memory_context>\nPrompt body';
