...
`@agentsy/agentic-loop` runs iterative agent loops with stop conditions, tool result feedback, and step lifecycle control.
...
```ts
import { createAgentLoop, isStepCount } from '@agentsy/agentic-loop';
