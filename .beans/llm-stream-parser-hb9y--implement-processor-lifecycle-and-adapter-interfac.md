...
updated_at: 2026-03-11T17:59:32Z
...
- [ ] Define processor types (`StreamChunk`, `ProcessorOptions`, `ProcessedOutput`, output parts/events) and state model.
- [ ] Implement `LLMStreamProcessor` (`process`, `processComplete`, `flush`, `reset`) with deterministic chunk semantics.
- [ ] Implement accumulated message accessors and event emitter hooks.
